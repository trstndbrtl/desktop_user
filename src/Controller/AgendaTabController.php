...
use Drupal\desktop_user\UserPageTabAgenda;
...
/**
 * Class AgendaTabController.
 */
class AgendaTabController extends ControllerBase {
  ...
  */
  public function __construct(UserPageTabAgenda $agenda) {
    $this->agenda = $agenda;
  }
  ...
  */
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('desktop_user.tab_agenda')
    );
  }
   ...
   *   Return Hello string.
   */
  public function userAgendaPage() {
  ...
  public function getCurrentPagePermission() {
    ...
    $perm = (isset($user->get('field_design')->getValue()[0]['agenda'])) ? $user->get('field_design')->getValue()[0]['agenda'] : 0;
    return (int)$perm;
  }
